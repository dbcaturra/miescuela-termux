...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    //Miescuela
    public static final String BIN_PATH = "/data/data/com.termux/files/usr/bin/";
    ...
    public void onCreate(Bundle bundle) {
        ...
        findViewById(R.id.miescuela_button).setOnLongClickListener(v -> {
            ...
            try {
                ...
                writer.append("LDFLAGS='-L/system/lib/' CFLAGS='-I/data/data/com.termux/files/usr/include/' pip install wheel pillow;");
                ...
                writer.append("git -C ~/storage/shared/ clone https://github.com/dbcaturra/miescuela-koala.git;");
                writer.append("cd ~/storage/shared/miescuela-koala && python manage.py migrate;");
                ...
                writer.append("git -C ~/storage/shared/ clone https://github.com/illuspas/Node-Media-Server;");
                writer.append("cd ~/storage/shared/nms/Node-Media-Server && npm i;");
                writer.flush();
                writer.close();
            ...
            Uri uriScript = new Uri.Builder().scheme("com.termux.file").path(HOME_PATH + "install.sh").build();
        ...
        findViewById(R.id.miescuela_button).setOnClickListener(v -> {
            ...
            try {
                ...
                writer.append("#!/bin/sh");
                writer.append("\n");
                writer.append("cd ~/storage/shared/miescuela-koala && python manage.py runserver 0.0.0.0:8080");
                writer.flush();
                writer.close();
                Toast.makeText(TermuxActivity.this, "****** running miescuela...", LENGTH_SHORT).show();
            } catch (Exception e) { System.out.println("Error writting file..");}
            Uri uriScript = new Uri.Builder().scheme("com.termux.file").path(HOME_PATH + "run.sh").build();
            Intent executeIntent = new Intent(ACTION_EXECUTE, uriScript);
            executeIntent.setClassName("com.termux", TERMUX_SERVICE);
            executeIntent.putExtra(EXTRA_EXECUTE_IN_BACKGROUND, true);
            Context context = getApplicationContext();
