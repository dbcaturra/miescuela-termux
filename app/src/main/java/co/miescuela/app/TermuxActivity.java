...
import co.miescuela.terminal.TerminalColors;
import co.miescuela.terminal.TerminalSession;
import co.miescuela.terminal.TerminalSession.SessionChangedCallback;
import co.miescuela.terminal.TextStyle;
import co.miescuela.view.TerminalView;
...
public final class TermuxActivity extends Activity implements ServiceConnection {
    ...
    /*public Uri getRawUri(String filename) {
        return Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + File.pathSeparator + File.separator + getPackageName() + "/res/raw/" + filename);
    }*/
    //Miescuela

    public static final String TERMUX_FAILSAFE_SESSION_ACTION = "co.miescuela.app.failsafe_session";
    ...
    private static final int CONTEXTMENU_MIESCUESLAADMIN = 10;
    private static final int CONTEXTMENU_MIESCUESLASTREAM = 11;

    private static final int MAX_SESSIONS = 8;

    private static final int REQUESTCODE_PERMISSION_STORAGE = 1234;

    private static final String RELOAD_STYLE_ACTION = "co.miescuela.app.reload_style";
    ...
    void checkForFontAndColors() {
        try {
            ...
            @SuppressLint("SdCardPath") File colorsFile = new File("/data/data/co.miescuela/files/home/.termux/colors.properties");
    ...
    public void onCreate(Bundle bundle) {
        ...
        findViewById(R.id.miescuela_button).setOnLongClickListener(v -> {
            ...
            try {
                ...
                writer.append("termux-setup-storage;");
                writer.append("pkg install python libjpeg-turbo libcrypt ndk-sysroot clang git ffmpeg nodejs -y;");
                writer.append("LDFLAGS='-L/system/lib/' CFLAGS='-I/data/data/co.miescuela/files/usr/include/' pip install wheel pillow;");
                writer.append("pip install 'django>=2.2' django-bootstrap-static django-koalalms-learning django-koalalms-accounts django-model-utils;");
                ...
                writer.append("echo \"from accounts.models import Person; Person.objects.create_superuser('admin', 'admin@miescuela.co', '!!password')\" | python manage.py shell;");
                ...
                writer.flush();
                writer.close();
                Toast.makeText(TermuxActivity.this, "install script created... and git installed", LENGTH_SHORT).show();
        ...
        findViewById(R.id.miescuela_button).setOnClickListener(v -> {
            //Me: Run method
            try {
                File installfile = new File(HOME_PATH + "run.sh");
                FileWriter writer = new FileWriter(installfile);
                writer.append("#!/bin/sh");
                writer.append("\n");
                writer.append("cd $EXTERNAL_STORAGE/miescuela-koala && python manage.py runserver 0.0.0.0:8080");
                writer.flush();
                writer.close();
                Toast.makeText(TermuxActivity.this, "****** running miescuela...", LENGTH_SHORT).show();
            } catch (Exception e) { System.out.println("Error writting file..");}
            Uri uriScript = new Uri.Builder().scheme("co.miescuela.file").path(HOME_PATH + "run.sh").build();
            Intent executeIntent = new Intent(ACTION_EXECUTE, uriScript);
            executeIntent.setClassName("co.miescuela", TERMUX_SERVICE);
            executeIntent.putExtra(EXTRA_EXECUTE_IN_BACKGROUND, true);
            Context context = getApplicationContext();
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        menu.add(Menu.NONE, CONTEXTMENU_MIESCUESLAADMIN, Menu.NONE, R.string.admin);
        menu.add(Menu.NONE, CONTEXTMENU_MIESCUESLASTREAM, Menu.NONE, R.string.stream);
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case CONTEXTMENU_STYLING_ID: {
                ...
                stylingIntent.setClassName("co.miescuela.styling", "co.miescuela.styling.TermuxStyleActivity");
                try {
                    ...
                    new AlertDialog.Builder(this).setMessage(R.string.styling_not_installed)
                        .setPositiveButton(R.string.styling_install, (dialog, which) -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=co.miescuela.styling")))).setNegativeButton(android.R.string.cancel, null).show();
                }
                return true;
            }
            case CONTEXTMENU_HELP_ID:
                ...
                return true;
            case CONTEXTMENU_MIESCUESLAADMIN:
                startActivity(new Intent(this, MiescuelaAdminActivity.class));
                return true;
            case CONTEXTMENU_MIESCUESLASTREAM:{
                startActivity(new Intent(this, MiescuelaStreamActivity.class));
    ...
    void showToast(String text, boolean longDuration) {
        ...
        mLastToast = Toast.makeText(TermuxActivity.this, text, longDuration ? Toast.LENGTH_LONG : LENGTH_SHORT);
